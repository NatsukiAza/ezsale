-- Alinear nombre de columna con esquema: id_product (no id_producto).
-- Idempotente para bases que ya tienen id_product.
...
begin
  if exists (
    ...
    alter table public.detalle_ventas rename column id_producto to id_product;
  end if;
end;
$$;
